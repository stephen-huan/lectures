...
\begin{enumerate}
  ...
  \item \href{https://en.wikipedia.org/wiki/3SUM}{3SUM}:
    ...
    Solution: Encode the list into a length \( 2N \) polynomial \( p \) where 
    the degree is the integer value and the coefficient is whether it appears
    in the array. Compute \( p^3 \) and read off the coefficient of \( x^0 \). 
